...
const DATA: Collection[] = [
  {
    slug: "photos-1",
    placeholderSeed: "silk-and-stone",
  ...
  {
    slug: "photos-2",
    placeholderSeed: "colorfield-malibu",
  ...
  {
    slug: "photos-3",
    placeholderSeed: "quiet-hours-sf",
    title: "Quiet Hours — San Francisco, 2023",
    statement: "Available light; clean lines; city exhales.",
    cta: "inquire",
    count: 12,
  },
];
