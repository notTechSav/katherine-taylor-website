  ...
  return (
    <section className="border-b border-border/60 bg-white py-16 sm:py-20">
      <div className="mx-auto flex max-w-[600px] flex-col items-center gap-4 px-6 text-center">
        ...
        <button
          type="button"
          className="inline-flex items-center justify-center border border-foreground px-8 py-2 text-[0.68rem] uppercase tracking-[0.38em] text-foreground transition hover:bg-foreground hover:text-background"
        >
          Shop
        </button>
      </div>
