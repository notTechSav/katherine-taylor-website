...
// Mobile-specific tiles (colored photo first)
const mobileTiles: ImageTile[] = [
  {
    src: "/gallery-third.png",
    alt: "Katherine Taylor in elegant red evening gown",
  },
...
const ImageMosaicSection = ({
  ...
  return (
    <>
      {/* Mobile layout - with swapped photos and centered text */}
      <section className="bg-luxury-white py-12 md:hidden">
        <div className="mx-auto flex flex-col gap-8">
          ...
          <div className="mx-auto grid w-full grid-cols-1 gap-8 px-8">
            {mobileTiles.map((tile, index) => (
              <article key={tile.src} className="group">
                <div className="relative aspect-[4/5] overflow-hidden">
                  <img
                    ...
                    className={cn(
                      ...
                      index === 0 ? "object-[50%_95%]" : "object-[50%_5%]"
                    )}
                  />
                </div>
              </article>
          ...
          {footerHeading || (footerLinkHref && footerLinkLabel) ? (
            <div className="pt-4 text-center px-8">
          ...
          <div className="mx-auto grid w-full max-w-[1600px] grid-cols-1 gap-16 px-12 md:grid-cols-2 md:gap-12 md:px-16 lg:grid-cols-3 lg:gap-24 lg:px-20">
            {displayTiles.map((tile, index) => {
              ...
              const hiddenClasses =
                ...
                index === 1 ? "" : // Always show second
                "hidden lg:block"; // Hide on tablet, show on desktop
