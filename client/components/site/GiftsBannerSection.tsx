const GiftsBannerSection = () => {
  return (
    <section className="bg-luxury-white py-12 md:py-24 md:py-32 lg:py-40">
      <div className="mx-auto grid max-w-luxury items-center gap-8 px-8 md:grid-cols-[minmax(0,1.05fr)_minmax(0,1fr)] md:gap-12 lg:gap-16">
        ...
        <div className="space-y-8 text-center md:text-left">
          ...
          <p className="mx-auto md:mx-0 max-w-[65ch] text-base font-light leading-relaxed tracking-luxury text-gray-700">
